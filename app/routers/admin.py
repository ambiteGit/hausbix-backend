...
def estado_pagos(_admin: models.Usuario = Depends(usuario_admin_actual)):
    """
    Comprueba, sin revelar ninguna clave, si las 5 variables de entorno
    de Stripe/Mercado Pago llegaron bien a Render — para saber de un
    vistazo si falta alguna, sin tener que probar un pago real ni ir a
    mirar el panel de Render directamente.
    """
    import os
    return {
        "stripe": {
        ...
        "mercadopago": {
            "MERCADOPAGO_APP_ID": bool(os.environ.get("MERCADOPAGO_APP_ID")),
            "MERCADOPAGO_CLIENT_SECRET": bool(os.environ.get("MERCADOPAGO_CLIENT_SECRET")),
